...
func (_m *Telebot) AttachAudio(chatID string, filename string, text string, option func(url.Values)) error {
	ret := _m.Called(chatID, filename, text, option)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, string, func(url.Values)) error); ok {
...
func (_m *Telebot) AttachFile(chatID string, filename string, text string, option func(url.Values)) error {
	ret := _m.Called(chatID, filename, text, option)
...
func (_m *Telebot) AttachPhoto(chatID string, filename string, text string, option func(url.Values)) error {
	ret := _m.Called(chatID, filename, text, option)
...
func (_m *Telebot) AttachVideo(chatID string, filename string, text string, option func(url.Values)) error {
	ret := _m.Called(chatID, filename, text, option)
...
func (_m *Telebot) EditInlineMarkup(chatID string, messageID int, markup *tbot.InlineKeyboardMarkup) error {
	ret := _m.Called(chatID, messageID, markup)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, int, *tbot.InlineKeyboardMarkup) error); ok {
...
func (_m *Telebot) ForwardAudio(chatID string, fileID string, text string, option func(url.Values)) error {
...
func (_m *Telebot) ForwardFile(chatID string, fileID string, text string, option func(url.Values)) error {
	ret := _m.Called(chatID, fileID, text, option)
...
func (_m *Telebot) ForwardPhoto(chatID string, fileID string, text string, option func(url.Values)) error {
	ret := _m.Called(chatID, fileID, text, option)
...
func (_m *Telebot) ForwardVideo(chatID string, fileID string, text string, option func(url.Values)) error {
	ret := _m.Called(chatID, fileID, text, option)
...
func (_m *Telebot) SendText(chatID string, text string, option func(url.Values)) error {
	ret := _m.Called(chatID, text, option)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, func(url.Values)) error); ok {
